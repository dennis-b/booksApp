...
function mdRadioGroupDirective(e, t, n, i) {
    ...
    function d(t, n) {
        ...
        if (i.count()) {
            ...
            }, o = t[0].querySelector("md-radio-button.md-checked"), a = i[0 > n ? "previous" : "next"](o, r) || i.first();
...
function mdRadioButtonDirective(e, t, n) {
    function i(i, o, a, d) {
        ...
        function c(e) {
            o[0].hasAttribute("disabled") || i.$apply(function () {
...
goog.provide("ng.material.components.radioButton"), goog.require("ng.material.core"), angular.module("material.components.radioButton", ["material.core"]).directive("mdRadioGroup", mdRadioGroupDirective).directive("mdRadioButton", mdRadioButtonDirective), mdRadioGroupDirective.$inject = ["$mdUtil", "$mdConstant", "$mdTheming", "$timeout"], mdRadioButtonDirective.$inject = ["$mdAria", "$mdUtil", "$mdTheming"], ng.material.components.radioButton = angular.module("material.components.radioButton");