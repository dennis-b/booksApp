...
function MdSubheaderDirective(e, a, r, n) {
    return {
        ...
        link: function (t, i, d, c, o) {
            ...
            o(t, function (e) {
                s(i).append(e)
            }), i.hasClass("md-no-sticky") || o(t, function (r) {
                var d = '<div class="md-subheader-wrapper">' + u + "</div>", c = a(d)(t);
                e(t, i, c), n.nextTick(function () {
                    s(c).append(r)
                })
            })
        }
