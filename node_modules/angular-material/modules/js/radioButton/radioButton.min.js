...
!function (e, t, n) {
    ...
    function i(e, n, i, r) {
            ...
            function u(i) {
                ...
                switch (r) {
                    ...
                    case n.KEY_CODE.UP_ARROW:
                        i.preventDefault(), l.selectPrevious(), c();
                        break;
                    case n.KEY_CODE.RIGHT_ARROW:
                    case n.KEY_CODE.DOWN_ARROW:
                        i.preventDefault(), l.selectNext(), c();
                        break;
        ...
        function s(n, i) {
            ...
            if (r.count()) {
                ...
                }, d = n[0].querySelector("md-radio-button.md-checked"), a = r[0 > i ? "previous" : "next"](d, o) || r.first();
    ...
    function r(e, t, n) {
        function i(i, o, d, a) {
            function s(e) {
                if (!a)throw"RadioGroupController not found.";
                a.add(u), d.$observe("value", u), o.on("click", c).on("$destroy", function () {
                    a.remove(u)
                })
            }
