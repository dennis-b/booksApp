...
!function (e, t, n) {
    "use strict";
    function o(e, n, o, i, r, s, u) {
        this.$element = n, this.$attrs = o, this.$mdConstant = i, this.$mdUtil = s, this.$document = r, this.$scope = e, this.$timeout = u;
        var a = this;
            ...
            require: ["mdMenuItem", "?ngModel"], compile: function (e, n) {
                ...
                function i(t) {
                    if (e[0].hasAttribute(t)) {
                        ...
                        s[0].setAttribute(t, n), e[0].removeAttribute(t)
                    }
                }

                if ("checkbox" == n.type || "radio" == n.type) {
                    var r = e[0].textContent, s = t.element('<md-button type="button"></md-button>');
                    s.html(r), s.attr("tabindex", "0"), e.html(""), e.append(t.element('<md-icon md-svg-icon="check"></md-icon>')), e.append(s), e[0].classList.add("md-indent"), o("role", "checkbox" == n.type ? "menuitemcheckbox" : "menuitemradio"), t.forEach(["ng-disabled"], i)
    ...
    o.$inject = ["$scope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], o.prototype.init = function () {
        var e = this.$element, o = this.$mdUtil, i = this.$scope, r = this;
        e.on("keydown", this.handleKeyDown), this.parentToolbar = o.getClosest(e, "MD-TOOLBAR"), i.$on("$mdMenuOpen", function (t, n) {
        ...
        }), i.$on("$mdMenuClose", function (t, i, s) {
            var u = r.getMenus();
            if (-1 != u.indexOf(i[0]) && (e[0].classList.remove("md-open"), i[0].classList.remove("md-open")), s.closeAll && e[0].contains(i[0])) {
                for (var l = i[0]; l && -1 == u.indexOf(l);)l = o.getClosest(l, "MD-MENU", !0);
        ...
        function e() {
            if ("radio" == u) {
                var e = r.ngValue ? i.$eval(r.ngValue) : r.value;
        ...
        var o = this.ngModel, i = this.$scope, r = this.$attrs, s = this.$element, u = this.mode;
        this.handleClick = t.bind(this, this.handleClick);
        var l = this.iconEl, a = t.element(this.buttonEl), d = this.handleClick;
        r.$observe("disabled", n), n(r.disabled), o.$render = function () {
            e() ? (l.style.display = "", s.attr("aria-checked", "true")) : (l.style.display = "none", s.attr("aria-checked", "false"))
        }, i.$$postDigest(o.$render)
    ...
    }, t.module("material.components.menuBar").directive("mdMenuItem", u)
