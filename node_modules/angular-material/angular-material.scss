...
$md-calendar-height: ($md-calendar-weeks-to-show * $md-calendar-cell-size) + $md-calendar-header-height;
...
$md-datepicker-border-bottom-gap: 5px;
// Space between input and the grey underline.
